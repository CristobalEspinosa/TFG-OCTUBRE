...
// Obtener todos los IDs de pedido
    echo "<div class='contenedor-principal'>";
            ...
            echo "<h4 class='dentroCards'>PARA REALIZAR:</h4>";
            ...
            foreach ($pedidos as $idPedido) {
                ...
                echo "<a href='?eliminar=$idPedido' class='boton'>Eliminar Pedido</a>";
                echo "</div>";
            ...
            echo "<div class='derecha'>";
                echo "<div class='siendoRealizadoss'>";
                echo "<h4 class='dentroCards'>REALIZADOS:</h4>";
            ...
            echo "<div class='abajo'>";
                echo "<div class='abajo-izquierda'>";
            ...
            foreach ($pedidos as $idPedido) {
                ...
                echo "</div>";
                echo "<div class='abajo-derecha'>";
                echo "<h4 class='dentroCards'>PAGADOS:</h4>";
                    $pedidos = obtenerIdsPedidoPagado();
                foreach ($pedidos as $idPedido) {
                    // Obtener los detalles del pedido
                    $detallesPedido = obtenerPedido($idPedido);
